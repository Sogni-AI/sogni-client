...
Wan 3 uses the single exact model ID `wan3.0-video` for text, first-frame, first+last-frame, loose-reference, audio-driven, and video-edit/extend workflows. It accepts 2-30 seconds, 480P/720P/1080P, ratios `16:9`, `4:3`, `1:1`, `3:4`, and `9:16`, optional native audio, up to 10 loose images, 5 videos, and 5 audios. Native first/last frames cannot be mixed with loose references. In English prompts, identify loose assets as `Image 1`, `Video 1`, and `Audio 1`, numbered independently by type. Wan 3 has no `negativePrompt` request field and is Premium Spark-only.
