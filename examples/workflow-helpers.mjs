...
export const MODELS = {
  ...
  s2v: {
    ...
    // LTX-2.3 Image+Audio to Video Dev (ia2v) - requires referenceImage + referenceAudio
    'ltx23-ia2v-dev': {
    ...
    // LTX-2.3 Audio to Video (a2v) - requires referenceAudio only, no referenceImage
    'ltx23-a2v-distilled': {
    ...
    // LTX-2.3 Audio to Video Dev (a2v) - requires referenceAudio only, no referenceImage
    'ltx23-a2v-dev': {
 ...
 *   outputDir: './output'
 * })
 * // => './output/ltx23-22b-fp8-t2v-distilled-20s-1920x1088-25fps-12345-45s-a-futuristic-city-at-night-with-neon-lights.mp4'
 */
