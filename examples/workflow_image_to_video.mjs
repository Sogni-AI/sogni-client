...
const DEFAULT_PROMPT = 'A cinematic camera movement that brings the image to life with smooth, natural motion';
...
Available Models:
  lightx2v - WAN 2.2 14B I2V LightX2V (fast, 4-step)
