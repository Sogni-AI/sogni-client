...
export interface SubscriptionEntitlementSnapshot {
   ...
   * (`gpt-image-2`, `seedance-2-0`, `seedance-2-0-mini`, `seedance-2-0-fast`). Present only when the
...
export interface SubscriptionPlan {
   ...
   * (`gpt-image-2`, `seedance-2-0`, `seedance-2-0-mini`, `seedance-2-0-fast`) while the member is
