 ...
 * - `requires_verification` — the account has not verified a payment method
 *   yet. Verifying one (a free Unlimited trial, or any Premium Spark purchase)
 *   unlocks it.
 * - `over_free_cap` — too much unspent free Spark on the account already.
 *
 ...
 */
export type RewardCantClaimReason =
  | 'already_claimed'
